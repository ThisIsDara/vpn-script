...
execute_step 5 $TOTAL_STEPS "Cloning 3x-ui repository from GitHub" "git clone https://github.com/MHSanaei/3x-ui"

# Step 6: Navigate to 3x-ui
execute_step 6 $TOTAL_STEPS "Entering 3x-ui directory" "cd 3x-ui && pwd"
progress_bar 0.5 "Ready for installation"

# Step 7: Make install script executable
execute_step 7 $TOTAL_STEPS "Setting execute permissions on install.sh" "chmod +x 3x-ui/install.sh"
progress_bar 0.5 "Permissions set"

# Step 8: Run installation
execute_step 8 $TOTAL_STEPS "Running 3x-ui installation" "./3x-ui/install.sh"
